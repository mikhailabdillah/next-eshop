...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-none border border-transparent bg-clip-padding text-xs font-semibold tracking-widest duration-200 whitespace-nowrap uppercase transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-primary border-2 border-primary text-primary-foreground hover:bg-primary/80",
        outline:
          "border-black/30 border-2 bg-transparent text-black/30 hover:border-black hover:text-black aria-expanded:bg-muted aria-expanded:text-foreground dark:hover:bg-input/30",
        secondary:
      ...
      size: {
        ...
        "icon-lg":
          "size-14 rounded-full border-2 border-primary hover:bg-transparent hover:border-primary/80 hover:text-primary",
      },
    },
    defaultVariants: {
      variant: "default",
